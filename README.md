[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=LZMSDFLJAVHQ6)
...
The current version support announcements for RoF, IGP, MoM, CoA and Xarth Mire's Fortress Siege Raid. You can use Rift Raid Alert with Team Speak so the whole Raid can benefit from.
