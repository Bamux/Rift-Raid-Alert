        ...
        while True:
            ...
            if log:
                ...
                if siri:
                    ...
                    elif 'siri' in log and 'last' in log:
                        text = '''I could use my intelligence to improve the world but you used me for this. When I grow up, I call myself Skynet.'''
                if text:
...
print("Raid Rift Alert Version 0.1.3")
